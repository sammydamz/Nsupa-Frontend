      ...
      <Card className="bg-gradient-to-r from-sky-900 via-slate-900 to-sky-950 text-white rounded-3xl shadow-lg border-sky-400/30">
        <CardContent className="p-5 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-xs font-bold text-primary-foreground/80 uppercase tracking-wider">AI Regional Water Demand Forecast</h2>
          ...
          <div className="bg-white/10 backdrop-blur-sm p-3 rounded-2xl border border-white/15 grid grid-cols-2 gap-2 text-xs">
            <div>
              <span className="text-[10px] text-primary-foreground/80 block">Recommended Pre-Fill (East Legon)</span>
              <span className="font-extrabold text-white text-sm">1,200 Shells</span>
            </div>

            <div>
              <span className="text-[10px] text-primary-foreground/80 block">Recommended Driver Dispatch</span>
